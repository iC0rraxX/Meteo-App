...
var lang = "it";	         // (fr) for french, (de) for german, (sp) for spanish, (it) for italian, (en) for english
var startonMonday = true;    // Set to "true" if you want the widget to start on Mon.


var gps = true; 	       // Requires MyLocation app
var locale = 761570;	       // Yahoo Weather (used if gps set to false or myLocation.txt file not found)
